        ...
        <div className='space-y-3'>
          {sessions.map(session => (
            <div key={session._id}
              ...
              <div className='bg-[#2C3E50] rounded-xl px-3 py-3 text-center flex-shrink-0 min-w-[72px]'>
              ...
              <span className='flex-shrink-0 text-xs bg-green-50 text-green-600
                               font-bold px-3 py-1 rounded-full h-fit'>
                Registered
              </span>
            </div>
          ))}
